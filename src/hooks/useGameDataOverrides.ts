...
export type DataType = 'moves' | 'equipment' | 'recipes' | 'monsters' | 'sprites' | 'shape_templates' | 'asset_image' | 'particle_template' | 'particle_effect' | 'particle_default' | 'world_gen';
