...
const SPECIES_PATHS: Record<SpeciesType, { body: string; detail: string; face: string }> = {
  // Fantasy creatures
  slime: {
    // Rounded blob with simple eyes
    body: "M50,18 Q80,18 80,50 Q80,82 50,85 Q20,82 20,50 Q20,18 50,18",
    detail: "",
    face: "M38,42 A5,5 0 1,1 38.01,42 M62,42 A5,5 0 1,1 62.01,42 M50,58 Q55,62 60,58",
  },
  skeleton: {
  ...
  rat: {
    // Rat with pointed snout, round ears, and long tail
    body: "M50,24 Q68,22 68,38 L70,55 L66,75 L56,90 L44,90 L34,75 L30,55 L32,38 Q32,22 50,24 M26,42 L32,40 M74,42 L68,40",
    detail: "M32,14 Q38,6 42,16 M68,14 Q62,6 58,16 M56,90 Q65,88 72,95 Q80,88 88,92 M40,65 L36,70 M60,65 L64,70",
    face: "M40,36 A4,4 0 1,1 40.01,36 M60,36 A4,4 0 1,1 60.01,36 M50,46 L50,56 L45,60 M45,56 L50,56 L55,56",
  },
  spider: {
